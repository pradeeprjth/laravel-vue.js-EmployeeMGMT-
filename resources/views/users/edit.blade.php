      ...
      <div class="col-md-8">
         <div class="card">
            <div class="card-header">{{ __('Update User') }}
               <a href="{{route('user.index')}}" class="float-right btn btn-sm btn-outline-dark">Back</a>
            </div>
            <div class="card-body">
...
<div class="modal fade" id="updatepasswordmodel" tabindex="-1" role="dialog" aria-labelledby="updatepasswordmodelLabel"
   aria-hidden="true">
   <div class="modal-dialog" role="document">
      <div class="modal-content">
         <div class="modal-header">
            <h5 class="modal-title" id="updatepasswordmodelLabel">Create New Password</h5>
